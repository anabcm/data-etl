...
class TransformStep(PipelineStep):
    def run_step(self, prev, params):
        ...
        df.rename(columns={'variable': 'year', 'value': 'population'}, inplace=True)
...
class MetroAreaPopulationPipeline(EasyPipeline):
    ...
    def steps(params):
        ...
        load_step = LoadStep(
            "conapo_metro_area_population", db_connector, if_exists="append", pk=["zona_metropolitana_id", "mun_id"], dtype=dtype, 
        )
