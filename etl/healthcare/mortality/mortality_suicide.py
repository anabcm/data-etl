...
class TransformStep(PipelineStep):
    def run_step(self, prev, params):
        ...
        # Columns related to suicides (amount and % per entity)
        df = df.loc[(df["id_indicador"] == 6200240338) | (df["id_indicador"] == 6200240526)]
...
class ENOEPipeline(EasyPipeline):
    ...
    def steps(params):
        ...
        load_step = LoadStep(
            "inegi_suicides_mortality", db_connector, if_exists="append", pk=["ent_id", "year"], dtype=dtype
        )
