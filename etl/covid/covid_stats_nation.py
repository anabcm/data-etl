...
class CovidStatsNationPipeline(EasyPipeline):
    ...
    def steps(params):
        ...
        dtypes = {
            ...
            'sum_last7_daily_cases':            "Int16",
            'sum_last7_daily_deaths':           "Int16",
            'sum_last7_accum_cases':            "Int16",
            'sum_last7_accum_deaths':           "Int16",
            'sum_last7_new_cases_report':       "Int16",
            'sum_last7_accum_cases_report':     "Int16",
            'sum_last7_new_deaths_report':      "Int16",
            'sum_last7_accum_deaths_report':    "Int16",
