...
class TransformStep(PipelineStep):
    def run_step(self, prev, params):
        ...
        report_cases = _report(BASE_URL + "/data.jsonrecords?Covid+Result=1&cube=gobmx_covid&drilldowns=Updated+Date%2CMunicipality&measures=Cases&parents=false&sparse=false")
        report_cases = report_cases.rename(columns={"reported_cases":"new_cases_report", "Cases":"accum_cases_report"})

        report_deaths = _report(BASE_URL + "/data.jsonrecords?Covid+Result=1&Is+Dead=1&cube=gobmx_covid&drilldowns=Updated+Date%2CMunicipality&measures=Cases&parents=false&sparse=false")
        report_deaths = report_deaths.rename(columns={"reported_cases":"new_deaths_report", "Cases":"accum_deaths_report"})

        report_hospitalized = _report(BASE_URL + "/data.jsonrecords?Covid+Result=1&Patient+Type=2&cube=gobmx_covid&drilldowns=Updated+Date%2CMunicipality&measures=Cases&parents=false&sparse=false")
        ...
        report_suspect = _report(BASE_URL + "/data.jsonrecords?Covid+Result=3&cube=gobmx_covid&drilldowns=Updated+Date%2CMunicipality&measures=Cases&parents=false&sparse=false")
        ...
        r = requests.get(BASE_URL + "/data?Year=2020&cube=population_projection&drilldowns=Municipality&measures=Projected+Population&parents=false&sparse=false")
        data_json = r.json()
        ...
        #Hospitalized
        df_hosp = df[["mun_id", "fecha_ingreso", "resultado_lab", "tipo_paciente"]]
        ...
        df2 = df[["mun_id", "fecha_ingreso", "fecha_def", "resultado_lab"]]
...
class CovidStatsMunPipeline(EasyPipeline):
    ...
    def steps(params):
        ...
        dtypes = {
            ...
            'daily_cases':                      "Int64",
            'daily_deaths':                     "Int64",
            'daily_hospitalized':               "Int64",
            'daily_suspect':                    "Int64",
            'accum_cases':                      "Int64",
            'accum_deaths':                     "Int64",
            'accum_hospitalized':               "Int64",
            'accum_suspect':                    "Int64",
            'days_between_ingress_and_death':   "Float32",
            'new_cases_report':                 "Int64",
            'new_deaths_report':                "Int64",
            'new_hospitalized_report':          "Int64",
            'new_suspect_report':               "Int64", 
            'accum_cases_report':               "Int64",
            'accum_deaths_report':              "Int64",
            'accum_hospitalized_report':        "Int64",
            'accum_suspect_report':             "Int64", 
            ...
            'sum_last7_new_cases_report':       "Int64",
            'sum_last7_accum_cases_report':     "Int64",
            'sum_last7_new_deaths_report':      "Int64",
            'sum_last7_accum_deaths_report':    "Int64",
